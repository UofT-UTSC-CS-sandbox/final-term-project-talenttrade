...
**Github:** https://github.com/UofT-UTSC-CS-sandbox/final-term-project-talenttrade
...
## product.md (Max 36 marks)
  ...
  - Market research has been done (max 5marks)
    ...
    Could have some informative data. Lack market size analysis.
...
## Presentation quality: (max 5 marks)
  ...
  Some inconsitency in format. E.g., mix use of numbers and bullet points in `README.md` contribution.
