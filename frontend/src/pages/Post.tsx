...
const Post: React.FC<PostProps> = ({ post }) => {
        ...
        return (
            <a href="#"  className={`post ${expand ? 'expand' : ''}`} onClick={() => 
            post.description.length > descriptionLmt && SetExpand(!expand)}>
                ...
                <div className="text"><span>Description: </span>{expand ? post.description : post.description.length > descriptionLmt 
                ? `${post.description.substring(0, descriptionLmt)}...` : post.description}</div>
